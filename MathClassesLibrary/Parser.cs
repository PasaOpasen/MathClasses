...
namespace МатКлассы
{
    ...
    //    /// <param name="x">Значение переменной</param>
    //    /// <param name="str">Строка формулы</param>
    //    public ParserComplex(double x, string str)
    //    {
    //        Clean(str);
    //        arg = x;
    //        ShowT();
    ...
    //    /// <param name="x">Значение переменной</param>
    //    /// <param name="str">Строка формулы</param>
    //    public ParserComplex(string s, double x) : this(x, s) { }
    ...
    //    //Метод обработки функций и присваивания значения переменной
    //    protected Complex Func(string s)
    //    {
    //        Complex element = 0.0;
    //        string el = "";
    //        foreach (char ch in s)
    ...
    //        //if (el == "ln") element = Complex.Log(val);
    ...
    //    }
    //    //Метод возведения в степень
    //    protected Complex Power(string s)
    //    {
    //        Complex element;
    //        string el = "";
    //        foreach (char ch in s)
    ...
    //        if (!s.Substring(el.Length + 1).Equals(String.Empty))
    //        {
    //            element = Complex.Pow(element, Element(s.Substring(el.Length + 1)));
    //        }

    //        return element;
    //    }
    //    //Расчет умножения/деления
    //    protected Complex Element(string s)
    //    {
    //        Complex element;
    //        string el = "";
    //        foreach (char ch in s)
